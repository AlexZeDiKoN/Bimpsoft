...
export const LINE_BLOCKAGE_SPIRAL = 'Спиральне загородження (однорядне)'
export const LINE_BLOCKAGE_SPIRAL2 = 'Спиральне загородження (дворядне)'
export const LINE_BLOCKAGE_SPIRAL3 = 'Спиральне загородження (трирядне)'
