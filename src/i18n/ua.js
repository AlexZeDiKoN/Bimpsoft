...
export const SAVE_SIGNS = 'Сохранить знак?'
export const ERROR_CODE_SIGNS = 'Помилка в коді знаку'
export const OBJECT = 'Об’єкт'
export const OBJECT_EXIST = 'вже існує на поточному шарі.'
export const CONTINUE_STORAGE = 'Продовжити зберігання?'
