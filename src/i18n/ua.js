...
export const MARCH_NAME = 'Назва маршруту'
export const OPEN_MARCH_FILE = 'Вибір існуючого маршруту'
export const MARCH_TYPE = 'Тип руху по маршруту'
export const GEOGRAPHICAL_LANDMARK = 'Географічний орієнтир'
export const CHECK_SEGMENT = 'Вибір відрізку'
export const SEGMENT_NAME = 'Назва відрізку'
export const ADD_SEGMENT = 'Додати пункт маршруту'
