...
export const UPDATE_GEOMETRY = 'Оновлено геометрію об’єкта'
export const UPDATE_ATTRIBUTES = 'Оновлено атрибути об’єкта'
export const UPDATE_PARTIALLY = 'Оновлено атрибути об’єкта та геометрію'
export const INSERT_OBJECT = 'Додано новий об’єкт'
export const DELETE_OBJECT = 'Видалено існуючий об’єкт'
export const DELETE_LIST = 'Видалино список об’єктів'
export const LAYER_COLOR = 'Встановлено колір виділення шару'
export const CREATE_CONTOUR = 'Створено контур'
export const DELETE_CONTOUR = 'Видалено контур'
export const COPY_CONTOUR = 'Скопійовано контур'
export const MOVE_CONTOUR = 'Переміщено контуру'
export const MOVE_LIST = 'Переміщено список об’єктів'
export const LOG_POINT = 'точковий знак (MilSymbol)'
export const LOG_SEGMENT = 'знак відрізкового типу'
export const LOG_AREA = 'замкнута крива лінія'
export const LOG_CURVE = 'незамкнута крива лінія'
export const LOG_POLYGON = 'замкнута ламана лінія (багатокутник)'
export const LOG_POLYLINE = 'незамкнута ламана лінія'
export const LOG_CIRCLE = 'коло'
export const LOG_RECTANGLE = 'прямокутник'
export const LOG_SQUARE = 'квадрат'
export const LOG_TEXT = 'текстова мітка'
export const LOG_CONTOUR = 'контур'
export const LOG_TARGETING = 'зона вогневого ураження'
export const LOG_GROUPED_HEAD = 'згрупований знак пунктів управління'
export const LOG_GROUPED_LAND = 'згрупований знак сухопутних об’єктів'
export const LOG_GROUPED_REGION = 'згрупований знак "Позиційний район підрозділу"'
export const LOG_SOPHISTICATED = 'складна лінія'
export const LOG_GROUP = 'група'
export const LOG_FLEXGRID = 'Операційна зона ("сіточка")' */
