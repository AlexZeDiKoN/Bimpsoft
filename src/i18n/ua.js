...
export const AZIMUT = 'Азимут'
export const AZIMUT1 = 'Азимут 1'
export const AZIMUT2 = 'Азимут 2'
...
export const LINE_MOAT_ANTITANK_UNFIN = 'Протитанковий рів (будуєтсья)'
export const LINE_MOAT_ANTITANK = 'Протитанковий рів'
export const LINE_MOAT_ANTITANK_MINE = 'Протитанковий рів з мінами'
export const LINE_BLOCKAGE_WIRE = 'Дротове загородження'
export const LINE_BLOCKAGE_WIRE1 = 'Дротове загородження (однорядне)'
export const LINE_BLOCKAGE_WIRE2 = 'Дротове загородження (дворядне)'
...
export const POINT_OF_REGULATION = 'Пункт(рубіж) регулювання'
export const DELETE_POINT_CONFIRM_TITLE = 'Ви впевнені що хочете видалити даний пункт?'
export const OK_BUTTON_TEXT = 'Так'
export const CANCEL_BUTTON_TEXT = 'Ні'
...
export const DELETE_SEGMENT_CONFIRM_TITLE = 'Ви впевнені що хочете видалити даний сегмент?'
