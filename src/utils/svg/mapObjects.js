...
import { frameMapSize, getMapObjectSvg, MM_IN_INCH } from './mapObject'
...
export const getMapSvg = (
  ...
  const width = bounds.max.x - bounds.min.x + frameWidth
  const height = bounds.max.y - bounds.min.y + frameWidth
