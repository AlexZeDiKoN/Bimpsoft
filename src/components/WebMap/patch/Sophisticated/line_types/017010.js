(function () {
  /* global lineDefinitions, STRATEGY, MIDDLE, DELETE, angleOf, normalVectorTo, applyVector, segmentLength, drawArc,
  segmentBy, drawMaskedText, halfPlane, drawLine, compose, translate, rotate, rad, applyToPoint */
