(function () {
  /* global lineDefinitions, STRATEGY, MIDDLE, DELETE, segmentLength, segmentBy, drawLine, drawArrow, angleOf, compose,
  translate, rotate, applyToPoint, getPointAt, addPathAmplifier, emptyPath */
