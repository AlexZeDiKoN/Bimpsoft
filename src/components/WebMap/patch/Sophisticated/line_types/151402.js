(function () {
  /* global lineDefinitions, MIDDLE, DELETE,  STRATEGY_ARROW, buildingAttackHelicopter, addPathAmplifier */
  ...
  lineDefinitions['151402'] = {
    ...
    render: (result, points, scale) => {
      ...
      const allPath = buildingAttackHelicopter(JSON.stringify(points), typeLine, bindingType)
      result.d = allPath.d
