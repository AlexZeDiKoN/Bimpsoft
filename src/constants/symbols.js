...
export const CompatibilityTacticalSymbol = [
  [ '012040', '017016', '017019', '017076', '120400', '170100', '272100' ], // несовместимые знаки
  [ '017020', '270701' ], // 1 координата
  [ '017011', '017049', '017078', '151205', '240701', '271600', '280100', '290400',
    '341100', '341200', '341300', '341500', '341700', '342100' ], // 2 координаты: (центр, радиус) или края линии
  [ '017006', '017010', '017015', '017032', '017056', '017063', '140500',
    '140601', '140602', '140603', '140605', '140800', '141700', '151204',
    '152000', '152200', '230200', '240805', '270501', '270502', '271400', '290500',
    '340100', '340200', '340300', '340400', '340500', '340800', '341000', '341800', '342000',
    '342201', '342202', '342203', '342400' ], // 3 координаты
  [ '017008', '017009', '017024', '152100', '271100', '271300', '341900', '342300' ], // 4 координаты
  [ '017018' ], // области
  [ '270800', '271700', '271701', '271800', '271801', '271900', '272000', '272001' ], // области + координата значка
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        amp: {
          type: entityKind.SOPHISTICATED,
          pointAmplifier: { [amps.N]: '', [amps.T]: '', [amps.W]: '' },
          params: {
